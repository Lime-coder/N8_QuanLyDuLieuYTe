...
BEGIN
    ...
    INSERT INTO hospital.staff (staff_id, full_name, gender, birthdate, id_card, hometown, phone, dept_id, staff_role, username_db, facility)
    VALUES ('NV_U4', UNISTR('Nh\00E2n vi\00EAn Th\1EA7n kinh'), UNISTR('N\1EEF'), TO_DATE('1990-01-01','YYYY-MM-DD'), 'OLS_004', UNISTR('Ch\01B0a r\00F5'), '0000000000', 'PB02', UNISTR('K\1EF9 thu\1EADt vi\00EAn'), 'U4', UNISTR('H\00E0 N\1ED9i'));
    ...
    INSERT INTO hospital.staff (staff_id, full_name, gender, birthdate, id_card, hometown, phone, dept_id, staff_role, username_db, facility)
    VALUES ('NV_U8', UNISTR('Nh\00E2n vi\00EAn Ti\00EAu h\00F3a'), UNISTR('N\1EEF'), TO_DATE('1995-01-01','YYYY-MM-DD'), 'OLS_008', UNISTR('Ch\01B0a r\00F5'), '0000000000', 'PB01', UNISTR('K\1EF9 thu\1EADt vi\00EAn'), 'U8', UNISTR('H\1EA3i Ph\00F2ng'));
...
BEGIN
    ...
    SA_USER_ADMIN.SET_USER_LABELS('HOSP_OLS_POL', 'U4', 'NV:TK:HN');
    ...
    SA_USER_ADMIN.SET_USER_LABELS('HOSP_OLS_POL', 'U8', 'NV:TH:HP');
END;
/

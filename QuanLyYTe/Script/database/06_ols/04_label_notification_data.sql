...
BEGIN
    DELETE FROM hospital_dba.notification;
...
INSERT INTO hospital_dba.notification (notification_id, description, posted_date, location, ols_label) 
...
CREATE OR REPLACE PROCEDURE hospital_dba.USP_GET_NOTIFICATIONS (
...
BEGIN
    OPEN p_cursor FOR
        ...
        FROM hospital_dba.notification
...
CREATE OR REPLACE PROCEDURE hospital_dba.USP_ADD_NOTIFICATION (
    ...
    v_id VARCHAR2(10);
BEGIN
    v_id := 'T' || hospital_dba.seq_notification_id.NEXTVAL;
...
GRANT SELECT ON hospital_dba.notification TO rl_dba, rl_coordinator, rl_doctor, rl_technician, rl_patient;
GRANT EXECUTE ON hospital_dba.USP_GET_NOTIFICATIONS TO rl_dba, rl_coordinator, rl_doctor, rl_technician, rl_patient;
GRANT EXECUTE ON hospital_dba.USP_ADD_NOTIFICATION TO rl_dba, rl_coordinator;
GRANT INSERT ON hospital_dba.notification TO rl_dba, rl_coordinator;
GRANT SELECT ON hospital_dba.seq_notification_id TO rl_dba, rl_coordinator;

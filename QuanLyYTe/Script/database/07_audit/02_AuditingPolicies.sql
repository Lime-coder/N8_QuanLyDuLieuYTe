...
NOAUDIT UPDATE ON hospital_dba.V_TECHNICIAN_PERSONAL_INFO;
...
-- NC#3: VIEW - Kỹ thuật viên cập nhật thông tin cá nhân (Ít xảy ra, có ý nghĩa Audit hơn)
AUDIT UPDATE ON hospital_dba.V_TECHNICIAN_PERSONAL_INFO BY ACCESS WHENEVER SUCCESSFUL;
AUDIT UPDATE ON hospital_dba.V_TECHNICIAN_PERSONAL_INFO BY ACCESS WHENEVER NOT SUCCESSFUL;

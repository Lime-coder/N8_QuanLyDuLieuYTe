...
-- Manage Oracle Users & Roles
-- ════════════════════════════════════════════════════════════════

-- Notes:
-- - CREATE/DROP/ALTER user/role requires dynamic SQL.
-- - Never concatenate raw identifiers; use DBMS_ASSERT to reduce SQL injection risk.
-- - Password is wrapped in quotes to preserve characters; escape " as "".

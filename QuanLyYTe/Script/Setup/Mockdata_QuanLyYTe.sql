...
-- 1. Departments
INSERT INTO department (dept_id, dept_name) VALUES ('D01', N'Nội tổng quát');
INSERT INTO department (dept_id, dept_name) VALUES ('D02', N'Ngoại thần kinh');
INSERT INTO department (dept_id, dept_name) VALUES ('D03', N'Chẩn đoán hình ảnh');
...
VALUES ('ST001', N'Nguyễn Văn Minh', N'Nam', TO_DATE('1990-01-01','YYYY-MM-DD'), '079012345678', '0901112223', 'D01', N'Bác sĩ', 'ST001');

INSERT INTO staff (staff_id, full_name, gender, birthdate, id_card, phone, dept_id, staff_role, username_db)
VALUES ('ST002', N'Trần Thị Mai', N'Nữ', TO_DATE('1992-05-15','YYYY-MM-DD'), '079012345679', '0904445556', 'D01', N'Điều phối viên', 'ST002');

INSERT INTO staff (staff_id, full_name, gender, birthdate, id_card, phone, dept_id, staff_role, username_db)
VALUES ('ST003', N'Lê Văn Tám', N'Nam', TO_DATE('1988-12-10','YYYY-MM-DD'), '079012345680', '0907778889', 'D03', N'Kỹ thuật viên', 'ST003');

INSERT INTO staff (staff_id, full_name, gender, birthdate, id_card, phone, dept_id, staff_role, username_db)
VALUES ('ST004', N'Phạm minh Anh', N'Nữ', TO_DATE('1995-08-20','YYYY-MM-DD'), '079012345681', '0909990001', 'D02', N'Bác sĩ', 'ST004');
...
VALUES ('MR001', 'BN001', SYSDATE - 5, N'Viêm dạ dày cấp', N'Uống thuốc sau ăn', 'ST001', 'D01', N'Tiếp tục theo dõi');

INSERT INTO medical_record (record_id, patient_id, record_date, diagnosis, treatment_plan, doctor_id, dept_id, conclusion)
VALUES ('MR002', 'BN002', SYSDATE - 2, N'Đau đầu mãn tính', N'Nghỉ ngơi, giảm áp lực', 'ST004', 'D02', N'Tái khám sau 1 tuần');

-- 5. Prescriptions
INSERT INTO prescription (record_id, prescription_date, medicine_name, dosage)
VALUES ('MR001', SYSDATE - 5, 'Omeprazole', N'20mg, 1 viên/ngày');

-- 6. Service Records
INSERT INTO service_record (record_id, service_type, service_date, technician_id, service_result)
VALUES ('MR002', N'Chụp MRI não', SYSDATE - 2, 'ST003', N'Hình ảnh bình thường, không có khối u');

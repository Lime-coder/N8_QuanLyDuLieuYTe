...
BEGIN
    ...
    INSERT INTO hospital.staff (staff_id, full_name, gender, birthdate, id_card, hometown, phone, staff_role, username_db, facility)
    VALUES ('NV_U1', N'Giám đốc OLS', N'Nam', TO_DATE('1970-01-01','YYYY-MM-DD'), 'OLS_001', N'Chưa rõ', '0000000000', N'Điều phối viên', 'U1', N'Hồ Chí Minh');

    INSERT INTO hospital.staff (staff_id, full_name, gender, birthdate, id_card, hometown, phone, staff_role, dept_id, username_db, facility)
    VALUES ('NV_U2', N'Lãnh đạo Tim mạch', N'Nữ', TO_DATE('1980-01-01','YYYY-MM-DD'), 'OLS_002', N'Chưa rõ', '0000000000', N'Bác sĩ', 'TM', 'U2', N'Hồ Chí Minh');

    INSERT INTO hospital.staff (staff_id, full_name, gender, birthdate, id_card, hometown, phone, staff_role, dept_id, username_db, facility)
    VALUES ('NV_U3', N'Lãnh đạo Thần kinh', N'Nam', TO_DATE('1981-01-01','YYYY-MM-DD'), 'OLS_003', N'Chưa rõ', '0000000000', N'Bác sĩ', 'TK', 'U3', N'Hà Nội');

    INSERT INTO hospital.staff (staff_id, full_name, gender, birthdate, id_card, hometown, phone, staff_role, dept_id, username_db, facility)
    VALUES ('NV_U4', N'Nhân viên Thần kinh', N'Nữ', TO_DATE('1990-01-01','YYYY-MM-DD'), 'OLS_004', N'Chưa rõ', '0000000000', N'Kỹ thuật viên', 'TK', 'U4', N'Hồ Chí Minh');

    INSERT INTO hospital.staff (staff_id, full_name, gender, birthdate, id_card, hometown, phone, staff_role, dept_id, username_db, facility)
    VALUES ('NV_U5', N'Nhân viên Tim mạch', N'Nam', TO_DATE('1992-01-01','YYYY-MM-DD'), 'OLS_005', N'Chưa rõ', '0000000000', N'Kỹ thuật viên', 'TM', 'U5', N'Hồ Chí Minh');

    INSERT INTO hospital.staff (staff_id, full_name, gender, birthdate, id_card, hometown, phone, staff_role, dept_id, username_db, facility)
    VALUES ('NV_U6', N'Lãnh đạo phòng HCM', N'Nữ', TO_DATE('1985-01-01','YYYY-MM-DD'), 'OLS_006', N'Chưa rõ', '0000000000', N'Bác sĩ', 'TM', 'U6', N'Hồ Chí Minh');

    INSERT INTO hospital.staff (staff_id, full_name, gender, birthdate, id_card, hometown, phone, staff_role, username_db, facility)
    VALUES ('NV_U7', N'Lãnh đạo phòng Tổng hợp', N'Nam', TO_DATE('1984-01-01','YYYY-MM-DD'), 'OLS_007', N'Chưa rõ', '0000000000', N'Bác sĩ', 'U7', N'Hải Phòng');

    INSERT INTO hospital.staff (staff_id, full_name, gender, birthdate, id_card, hometown, phone, staff_role, dept_id, username_db, facility)
    VALUES ('NV_U8', N'Nhân viên Tiêu hóa', N'Nữ', TO_DATE('1995-01-01','YYYY-MM-DD'), 'OLS_008', N'Chưa rõ', '0000000000', N'Kỹ thuật viên', 'TH', 'U8', N'Hà Nội');
